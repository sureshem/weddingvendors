    ...
    return (
        <>
            ...
            <style jsx>
                {
                    `
                    .btn{background-color: transparent;transition: 0.5s;max-width:180px;width: 100%; margin:20px auto 10px;border: 1px solid #b76f7a; padding: 15px; border-radius: 3px; font-size: 14px; color: #b76f7a;line-height:15px;text-align:center;}
